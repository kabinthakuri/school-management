...
<!-- Basic Forms -->
 <div class="box">
   ...
   <div class="box-body">
     <div class="row">
       <div class="col">
           <form action="{{route('registration.promoteupdate',$editData->student_id)}}" method="post" enctype="multipart/form-data">
               @csrf
                <div class="row">
                  <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="submit" class="btn btn-info btn-rounded mb-5" value="Promote">
