       ...
       <div class="col">
        ...
        <div class="controls">
            <select name="feecategory_id"  class="form-control">
                ...
                <option value="{{$class->id}}" @if($editData[0]->class_id == $class->id)selected @endif>{{$class->name}}</option>
                @endforeach
        ...
        <div class="controls">
            <select name="subject_id[]"  class="form-control">
                ...
                <option value="{{$subject->id}}" @if($edit->subject_id == $subject->id)selected @endif>{{$subject->name}}</option>
                @endforeach
